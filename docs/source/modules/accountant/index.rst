...
Dans l’espace **Agence**, l’entrée **Plan comptable** permet de consulter uniquement les comptes rattachés à l’agence de l’employé connecté (filtrage appliqué côté backend).

Note – Workflow Caisse
~~~~~~~~~~~~~~~~~~~~~~

L’ouverture/approvisionnement de caisse, sa confirmation (avec génération des écritures comptables) et la clôture de caisse sont décrits dans le guide utilisateur du module.
